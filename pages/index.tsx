      ...
      <div className="flex flex-col pt-20 bg-[#F91100] pb-10 w-full px-20  bg-sanka bg-contain bg-no-repeat bg-[right_-5rem_top_2rem] bg-opacity-75">
        ...
        <div className="flex flex-row gap-9 flex-wrap mt-10">
          <Link
            href="https://medium.com/samurai-starter"
            target="_blank"
            className="flex items-center font-black gap-5 text-white p-8 rounded-xl bg-black transition-all hover:scale-105 hover:opacity-90"
          >
            <svg
            ...
            <span className="text-3xl">Partner Quests</span>
          </Link>
          <Link
            href="https://medium.com/samurai-starter"
            target="_blank"
        ...
        <Link
          href="https://medium.com/samurai-starter"
          target="_blank"
          className="flex justify-center items-center font-black gap-5 text-white p-8 rounded-xl bg-black transition-all hover:scale-105 hover:opacity-90 mt-6 max-w-[690px]"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="46"
