...
export const FACTORY_ABI = [
  { type: "constructor", inputs: [], stateMutability: "nonpayable" },
  {
    ...
    inputs: [
      {
        name: "initialConfig",
        type: "tuple",
        internalType: "struct IFactory.InitialConfig",
        components: [
          {
            name: "samuraiTiers",
            type: "address",
    ...
    outputs: [{ name: "ido", type: "address", internalType: "contract IDO" }],
    stateMutability: "nonpayable",
  },
  {
    type: "function",
    name: "idos",
    inputs: [{ name: "index", type: "uint256", internalType: "uint256" }],
    outputs: [{ name: "idoAddress", type: "address", internalType: "address" }],
    stateMutability: "view",
  },
  {
    type: "function",
