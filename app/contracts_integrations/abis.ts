...
export const VESTING_ABI = [
  {
    ...
    inputs: [
      ...
      { name: "_points", type: "address", internalType: "address" },
      {
        name: "_tgeReleasePercent",
        type: "uint256",
        internalType: "uint256",
      },
      {
        name: "_pointsPerToken",
        type: "uint256",
        internalType: "uint256",
      },
      {
      ...
      },
      {
        name: "_periods",
        type: "tuple",
        internalType: "struct IVesting.Periods",
        components: [
          {
  ...
  },
  {
    ...
    name: "askedRefund",
    inputs: [{ name: "wallet", type: "address", internalType: "address" }],
    outputs: [{ name: "askedRefund", type: "bool", internalType: "bool" }],
    stateMutability: "view",
  },
  {
    type: "function",
  ...
  },
  {
    ...
    name: "purchases",
    inputs: [{ name: "wallet", type: "address", internalType: "address" }],
    outputs: [{ name: "purchased", type: "uint256", internalType: "uint256" }],
    stateMutability: "view",
  },
  {
    type: "function",
  ...
  {
    type: "error",
    name: "IVesting__Invalid",
    inputs: [{ name: "message", type: "string", internalType: "string" }],
  },
  {
    type: "error",
    name: "IVesting__Unauthorized",
    inputs: [{ name: "message", type: "string", internalType: "string" }],
  },
  {
    type: "error",
...
export const LATEST_PARTICIPATOR_TOKENS_ABI = [
  {
    type: "constructor",
    inputs: [
      {
...
export const VESTING_ABI_V2 = [
  {
    ...
    inputs: [
      ...
      {
        name: "_vestingPeriodType",
        type: "uint8",
        internalType: "enum IVesting.PeriodType",
      },
      {
        name: "_periods",
        type: "tuple",
...
export const NFT_LOCK_ABI = [
  {
    type: "constructor",
    inputs: [
      { name: "_samNFT", type: "address", internalType: "address" },
      { name: "_points", type: "address", internalType: "address" },
    ],
    stateMutability: "nonpayable",
  },
  ...
  },
  {
    ...
    name: "locksAt",
    inputs: [{ name: "tokenId", type: "uint256", internalType: "uint256" }],
    outputs: [{ name: "lockedAt", type: "uint256", internalType: "uint256" }],
    stateMutability: "view",
  },
  {
    type: "function",
    name: "locksCounter",
    inputs: [{ name: "wallet", type: "address", internalType: "address" }],
    outputs: [{ name: "total", type: "uint8", internalType: "uint8" }],
    stateMutability: "view",
  },
  {
    type: "function",
...
export const SAMURAI_POINTS_ABI = [
  { type: "constructor", inputs: [], stateMutability: "nonpayable" },
  {
    type: "function",
    name: "BOOSTER_ROLE",
  ...
  },
  {
    type: "function",
    name: "boosts",
    inputs: [{ name: "boost", type: "uint8", internalType: "uint8" }],
    outputs: [{ name: "multiplier", type: "uint256", internalType: "uint256" }],
    stateMutability: "view",
  },
  {
    ...
    inputs: [
      { name: "from", type: "address", internalType: "address" },
      { name: "numOfPoints", type: "uint256", internalType: "uint256" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
    ...
    inputs: [
      {
        name: "role",
        type: "uint8",
        internalType: "enum IPoints.Roles",
      },
      { name: "account", type: "address", internalType: "address" },
    ],
    outputs: [],
  ...
  // },
  {
    ...
    inputs: [
      { name: "to", type: "address", internalType: "address" },
      { name: "boost", type: "uint8", internalType: "uint8" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
...
export const LP_STAKING_ABI = [
  ...
  },
  {
    ...
    name: "lastClaims",
    inputs: [{ name: "wallet", type: "address", internalType: "address" }],
    outputs: [{ name: "claimedAt", type: "uint256", internalType: "uint256" }],
    stateMutability: "view",
  },
  {
    type: "function",
  ...
  },
  {
    ...
    inputs: [
      { name: "wallet", type: "address", internalType: "address" },
      { name: "stakeIndex", type: "uint256", internalType: "uint256" },
    ],
    outputs: [{ name: "", type: "uint256", internalType: "uint256" }],
    stateMutability: "view",
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: "stakePeriod", type: "uint256", internalType: "uint256" },
      {
        name: "claimedPoints",
        type: "uint256",
        internalType: "uint256",
...
export const SAM_LOCK_V2_ABI = [
  {
    type: "constructor",
    inputs: [
      { name: "_sam", type: "address", internalType: "address" },
      { name: "_pastLock", type: "address", internalType: "address" },
      { name: "_points", type: "address", internalType: "address" },
      { name: "_minToLock", type: "uint256", internalType: "uint256" },
    ],
    stateMutability: "nonpayable",
  ...
  {
    type: "function",
    name: "migrateVirtualPointsToTokens",
    inputs: [],
    outputs: [],
    stateMutability: "nonpayable",
  },
  ...
  {
    type: "function",
    name: "updateMinToLock",
    inputs: [{ name: "_minToLock", type: "uint256", internalType: "uint256" }],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
...
export const MISSING_POINTS_ABI = [
  {
    type: "constructor",
    inputs: [
      { name: "_points", type: "address", internalType: "address" },
  ...
  },
  {
    ...
    name: "iLock",
    inputs: [],
    outputs: [{ name: "", type: "address", internalType: "contract ILock" }],
    stateMutability: "view",
  },
  {
    type: "function",
...
export const VESTING_ABI_V4 = [
  {
    ...
    inputs: [
      ...
      { name: "_isRefundable", type: "bool", internalType: "bool" },
      {
        name: "_vestingType",
        type: "uint8",
        internalType: "enum IVesting.VestingType",
